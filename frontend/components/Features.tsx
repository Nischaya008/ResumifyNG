...
import { Target, MonitorPlay, Code2, LineChart } from 'lucide-react';
...
const features = [
  ...
  },
  {
    ...
    desc: "Watch your ATS standing improve over time with our dynamic performance graphs. Track your total mock interviews, review past resumes, and download full interview transcripts to analyze your progress.",
    color: "bg-orange-500"
  }
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 max-w-6xl mx-auto">
          {features.map((feature, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="group relative bg-[#050B14]/50 border border-[#4A70A9]/30 rounded-3xl p-6 sm:p-8 overflow-hidden hover:border-[#8FABD4]/50 transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)] flex flex-col h-full"
            >
